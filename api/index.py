...
def mcp_endpoint():
    server_info = {
        "name": "Zephyrax Agent Server",
        "version": "1.0.0",
        "website": "https://zephyrax-api.vercel.app",
...
def a2a_endpoint():
    return jsonify({
        ...
        "active": True,
        "x402support": True,
        "image": "https://blob.8004scan.app/767928839938673663b3f1f0682a96755918d282d7628839d514cd8e92b46e8f.jpg", 
        "tags": [
            "AI",
            "autonomous",
            "superfluid",
        ...
        "version": "1.0.0",
        "description": "Zephyrax is a smart AI agent for easy data analysis. It helps you understand datasets, make charts, and forecast trends fast on the Base network",
        "services": [
            {
                "name": "MCP",
                "version": "2025-06-18",
                "endpoint": "https://zephyrax-api.vercel.app/mcp",
                "transport": "http"
            },
            {
                "name": "A2A",
                "version": "0.3.0",
                "endpoint": "https://zephyrax-api.vercel.app/.well-known/agent-card.json",
                "transport": "http"
            }
        ],
        "registrations": [
...
def oasf_endpoint():
    return jsonify({
        ...
        "name": "zephyrax",
        "version": "v0.8.0",
        "description": "Main endpoint for Zephyrax AI analytics",
        "website": "https://zephyrax-api.vercel.app",
        "protocols": ["mcp","a2a"],
